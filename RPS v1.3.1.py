...
def quick():
    ...
    while True:
        ...
        while True:
            player_one = input("PLAYER ONE: play rock, paper, or scissors: ").lower()
        ...
        while True:
            player_two = input("PLAYER TWO: play rock, paper, or scissors: ").lower()
...
def compnormal():
    ...
    usr_round_nmb = input("Please enter the number of rounds you want to play: ").lower()
    if usr_round_nmb == "leave":
        print("The programme will finish now.")
        quit()
...
def normal():
    ...
    def game_round():    # define any round in normal game mode
        # general loop in normal game mode round
        rc = 1    # round counter
        plonesc = 0     # player one score
        pltwosc = 0       # player one score
        ...
        while True:
            ...
            while True:
                ...
                while True:
                    player_two = input("PLAYER TWO: play rock, paper, or scissors: ").lower()
                    if player_two == "get results":      # break if early results requested after player two round
                        break
                ...
                # general loop scoring conditions + messages
                if rc > usr_round_nmb or player_one == "get results" or player_two == "get results":
                    break
                if player_one == "rock" and player_two == "paper":
            ...
            # evaluate scores after all rounds
            if rc > usr_round_nmb or player_one == "get results":
                if plonesc > pltwosc:
    ...
    game_round()     # begin round loops


# main game loop, the programme starts here with Welcome screen
while True:
    try:
        choice = input("Welcome to the Rock Paper Scissors game. You can quit by typing 'leave'.\nChoose mode: type 'quick match', 'normal game', 'computer quick match' and 'computer normal game': ").lower()
        if choice == "quick match":
            quick()     # quick match launcher
            again = input("Do you want to play again (y/n)? ").lower()   # quick match mode loops ends here, main game loop continues
            if again == "y":  # y/n continue checker
                continue    # main loop again
            if again == "n":    # leave main loop, go to exit
                break
        elif choice == "normal game":
            normal()    # normal game launcher
            again = input("Do you want to play again (y/n)? ").lower()   # normal mode loops ends here, main game loop continues
            if again == "y":    # y/n continue checker
                continue    # main loop again
            if again == "n":
                break   # leave main loop, go to exit
        elif choice == "computer quick match":
            ...
            if again == "n":    # leave main loop, go to exit
                break
        elif choice == "computer normal game":
